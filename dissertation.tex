...
% OPTION
% Create the correction version for your first examiner. Therefore the front page is different, it is printed single-paged and it does not include the preface.
\newcommand{\VORLEGEN}{}
...
% Include front cover
\pagenumbering{Alph}
\includepdf[pages=1]{tikz/cover_front.pdf}
\cleardoublepage
...
% Back cover
\cleardoublepage
\includepdf[pages=1]{tikz/cover_back.pdf}
