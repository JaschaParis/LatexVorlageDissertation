...
\input{content/cover-front-content}
...
\node [anchor=center, text=RWTHhellblau, text width=150mm, rotate=90, align=center,font=\Large] (rueckentext) at ($(nullpunkt_ruecken)!0.5!(maxpunkt_ruecken)$) {\textsf{\disstitleDE}};

\node [anchor=west, text=RWTHhellblau, rotate=90, align=center,font=\Large] (rueckenautor) at ($(nullpunkt_ruecken) + (\ruecken/2,10)$) {\textsf{\dissauthor}};
